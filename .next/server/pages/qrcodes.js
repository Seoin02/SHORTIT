...
/* harmony export */   "default": () => (/* reexport safe */ private_next_pages_qrcodes_index_js__WEBPACK_IMPORTED_MODULE_0__.Z),
/* harmony export */   "getServerSideProps": () => (/* reexport safe */ private_next_pages_qrcodes_index_js__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var private_next_pages_qrcodes_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6906);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([private_next_pages_qrcodes_index_js__WEBPACK_IMPORTED_MODULE_0__]);
private_next_pages_qrcodes_index_js__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function QRCode({ className , title , value  }) {
    ...
    return /*#__PURE__*/ jsx_runtime.jsx((external_react_qr_code_default()), {
        className: className,
        value: value,
...
function QRCodeItem({ value , onDelete  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime.jsx(QRCode, {
...
function QRCodeList({ items =[] , onDelete  }) {
    return /*#__PURE__*/ jsx_runtime.jsx("ul", {
        ...
        children: items.map((item)=>/*#__PURE__*/ jsx_runtime.jsx("li", {
                children: /*#__PURE__*/ jsx_runtime.jsx(QRCodeItem, {
                    value: item,
                    onDelete: onDelete
                })
            }, item._id))
...
/* harmony export */   "Z": () => (/* binding */ QRCodeListPage)
/* harmony export */ });
...
function QRCodeListPage({ qrcodes: initialQRCode  }) {
    const [qrcodes, setQRcodes] = (0,react__WEBPACK_IMPORTED_MODULE_8__.useState)(initialQRCode);
    async function handleDelete(id) {
        await _lib_axios__WEBPACK_IMPORTED_MODULE_7__/* ["default"]["delete"] */ .Z["delete"](`/qrcodes/${id}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [521,636,675,664,556,250,41], () => (__webpack_exec__(7659)));
